...
class CoordinatorNetwork(TorchModelV2, nn.Module):
    """Policy/value model for the top-level coordinator agent."""
...
ModelCatalog.register_custom_model("coordinator_network", CoordinatorNetwork)
